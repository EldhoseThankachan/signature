...
<html lang="en">
   ...
   <!-- Site CSS -->
   <link rel="stylesheet" href="style.Assets/Templates/Main/css">
   <!-- Colors CSS -->
   <link rel="stylesheet" href="Assets/Templates/Main/css/colors.cs">
   <!-- ALL VERSION CSS -->	
   <link rel="stylesheet" href="Assets/Templates/Main/css/versions.css">
   <!-- Responsive CSS -->
   ...
   <script src="Assets/Templates/Main/js/3dslider.js"></script>
   </head>
   <body class="game_info" data-spy="scroll" data-target=".header">
      <!-- LOADER -->
      <div id="preloader">
         <img class="preloader" src="/loading-img.gif" alt="">
      </div>
      <!-- END LOADER -->
      <section id="top">
         <header>
               ...
               <div class="header-top">
                  <div class="row">
                     <div class="col-md-6">
                        <div class="full">
                          <div class="logo">
                              <a href=><img src="Assets/Templates/Main/images/logoesports3.png" width="300" height="80"/></a>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="right_top_section">
                           ...
                           <ul class="login">
                              <li class="login-modal">
                                 <a href="Guest/Login.php" class="login"><i class="fa fa-user"></i>Login</a>
                              </li>
                            </ul>
                           <!-- end button section -->
                        </div>
                                 ...
                                 <nav class="navbar navbar-inverse">
                                    ...
                                    <div class="collapse navbar-collapse js-navbar-collapse">
                                       <ul class="nav navbar-nav">
                                          ...
                                          <li><a href="Guest/Organization.php">Organizer</a></li>
                                                      ...
                                                      <div id="menCollection" class="carousel slide" data-ride="carousel">
                                                         <div class="carousel-inner">
                                                            <div class="item active">
                                                               <div class="banner-for-match"><a href="#"><img class="img-responsive" src="/match-banner1.jpg" alt="#" /></a></div>
                                                            </div>
                                                            <!-- End Item -->
                                                           <!--<div class="item">
            ...
            <div class="row">
                  ...
                  <aside id="sidebar" class="left-bar">
                     <div class="feature-matchs">
                        <div class="team-btw-match">
                           ...
                           <ul>
                              <li>
                                 <img src="/img-03_002.png" alt="">
                                 <span>Portugal</span>
                              </li>
                              <li class="vs"><span>vs</span></li>
                              <li>
                                 <img src="/img-04_003.png" alt="">
                                 <span>Germany</span>
                              </li>
                           </ul>
                           <ul>
                              <li>
                                 <img src="/img-05_002.png" alt="">
                                 <span>Portugal</span>
                              </li>
                              <li class="vs"><span>vs</span></li>
                              <li>
                     ...
                     <div class="feature-matchs">
                        <table class="table table-bordered table-hover">
                           ...
                           <tbody>
                              <tr>
                                 <td>1</td>
                                 <td><img src="/img-01_004.png" alt="">Liverpool</td>
                                 <td>10</td>
                                 <td>12</td>
                                 <td>20</td>
                              </tr>
                              <tr>
                                 <td>2</td>
                                 <td><img src="/img-02_002.png" alt="">Chelsea</td>
                                 <td>10</td>
                                 <td>12</td>
                                 <td>20</td>
                              </tr>
                              <tr>
                                 <td>3</td>
                                 <td><img src="/img-03_003.png" alt="">Norwich City</td>
                                 <td>20</td>
                                 <td>15</td>
                                 <td>20</td>
                              </tr>
                              <tr>
                                 <td>4</td>
                                 <td><img src="/img-04_002.png" alt="">West Brom</td>
                                 <td>60</td>
                                 <td>10</td>
                                 <td>60</td>
                              </tr>
                              <tr>
                                 <td>5</td>
                                 <td><img src="/img-05.png" alt="">sunderland</td>
                                 <td>30</td>
                                 <td>06</td>
                                 <td>30</td>
                              </tr>
               ...
               <div class="col-lg-8 col-sm-8 col-xs-12">
                  <div class="news-post-holder">
                     ...
                     <div class="news-post-widget">
                        <img class="img-responsive" src="/img-02_003.jpg" alt="">
                        <div class="news-post-detail">
                           <span class="date">20 march 2016</span>
                           <h2><a href="blog-detail.html">At vero eos et accusamus et iusto odio dignissimos ducimus</a></h2>
                           <p>Just hours after that his grandma had died, Angel Di Maria imagined how she might react if he didn't play</p>
                  ...
                  <div class="news-post-holder">
                     <div class="news-post-widget">
                        <img class="img-responsive" src="/img-03_003.jpg" alt="">
                        <div class="news-post-detail">
                           <span class="date">20 march 2016</span>
                           <h2><a href="blog-detail.html">At vero eos et accusamus et iusto odio dignissimos ducimus</a></h2>
                           <p>Just hours after that his grandma had died, Angel Di Maria imagined how she might react if he didn't play</p>
               ...
               <div class="col-md-4">
                  <div class="full">
                     <div class="footer-widget">
                        ...
                        <p>Most of our events have hard and easy route choices as we are always keen to encourage new gamers.</p>
                  ...
                  <div class="full">
                     <div class="footer-widget">
                        ...
                        <ul class="address-list">
                           ...
                           <li><i style="font-size:20px;top:5px;" class="fa fa-envelope"></i>etournix@gmail.com</li>
                        </ul>
                     </div>
                  </div>
               </div>
